...
### 📊 Instance && Network && Volume created
![OpenStack Instance](images/Instance_Openstack%20_dashbards.png)

![OpenStack Network](images/Network_topology_Openstack.png)

![OpenStack Volume](images/volume_list.png)
